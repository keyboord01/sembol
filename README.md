...
| CI | `.github/workflows/ci.yml` | ✅ Build + typecheck + 101 tests on every push |
...
| Path | What it is |
| --- | --- |
| [`packages/passkey-react`](packages/passkey-react) | **`@sembol/passkey-react`** - the component library + headless hooks (TypeScript, MIT). 9 components, 12 hooks (incl. recovery, multi-signer, and spending limits), WebAuthn edge-case handling, typed errors, CSS-variable theming, 101 unit/smoke tests. |
...
pnpm test           # 101 vitest unit + component smoke tests
